...
## [0.6.0](https://github.com/noxware/dial9/compare/dial9-v0.5.0...dial9-v0.6.0) - 2026-09-15

### Added

- *(cpu)* add system info as segement metadata ([#901](https://github.com/noxware/dial9/pull/901))
- improve FreeBSD runtime telemetry ([#721](https://github.com/noxware/dial9/pull/721))
- *(viewer)* add off-CPU points of interest ([#876](https://github.com/noxware/dial9/pull/876))
- *(viewer)* add spawn-to-first-poll delay POI ([#874](https://github.com/noxware/dial9/pull/874))

### Fixed

- *(taskdump)* remove unreleased capture changes ([#899](https://github.com/noxware/dial9/pull/899))
...
- *(core)* stop rotation stranding events between files ([#891](https://github.com/noxware/dial9/pull/891))
...
- cleanup README ([#894](https://github.com/noxware/dial9/pull/894))
- add shuttle coverage for concurrent Tokio runtime attach ([#873](https://github.com/noxware/dial9/pull/873))
- *(dial9-core)* add shuttle coverage for the dump-trigger debounce gate ([#877](https://github.com/noxware/dial9/pull/877))
...
- *(dial9-utils)* add shuttle coverage for the tracing-layer schema cache ([#878](https://github.com/noxware/dial9/pull/878))
- Reuse tracing schemas across span lifecycle events ([#900](https://github.com/noxware/dial9/pull/900))
