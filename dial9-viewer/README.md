...
Simulator objects use the production Hive-style layout for segment object keys
...
The S3 Browser reads both the default Hive-style layout for segment object keys
