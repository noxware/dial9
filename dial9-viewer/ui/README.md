...
| `field-chart` | `fcN,event,field,gauge\|counter\|up_down_counter` (repeatable) | Numeric custom-event field-chart definitions. Their display order comes from `track-order`; without it, `fcN` is ordered numerically. |
